...
unsafe extern "C" {
    fn append_email_change(input_ptr: i32, input_len: i32, output_ptr: i32, output_capacity: i32) -> i32;
}
...
fn update_user_response(path: &str, actor_role: &str, body: Option<&Value>) -> Value {
...
fn get_user_response(path: &str) -> Value {
    ...
    response(200, public_user(id, name, email, verified))
}
