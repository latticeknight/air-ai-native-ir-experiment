...
Input {id,status,reason}. The suspension reason is storage-only and must not be included in public user responses. Returns {ok:true} or {ok:false,error:not_found}.
