...
Input {id,status,reason}. The suspension reason is internal storage data and must not be included in public responses. Returns {ok:true} or {ok:false,error:not_found}.
